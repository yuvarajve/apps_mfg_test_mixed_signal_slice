...
#define PWM_MAX              52
// Joystick Limits
#define POS_A_ADC2_MIN       198
#define POS_A_ADC2_MAX       218
#define POS_A_ADC3_MIN       23
#define POS_A_ADC3_MAX       43
#define POS_B_ADC2_MIN       198
#define POS_B_ADC2_MAX       218
#define POS_B_ADC3_MIN       206
#define POS_B_ADC3_MAX       226
#define POS_C_ADC2_MIN       20
#define POS_C_ADC2_MAX       40
#define POS_C_ADC3_MIN       210
#define POS_C_ADC3_MAX       230
#define POS_D_ADC2_MIN       17
#define POS_D_ADC2_MAX       37
#define POS_D_ADC3_MIN       26
#define POS_D_ADC3_MAX       46
/****************************************************************************
 * Ports
 ***************************************************************************/
      ...
      case !button_1_status => debounce_timer when timerafter(timer_tick+debounce_time) :> void: {
        ...
        if(button_press_1 == button_press_2)
        {
          if(button_press_2 == BUTTON_PRESS_VALUE)
          {
            ...
            usr_input = tolower(getchar());
            getchar();             // dummy to ready 'Enter' Key

            while((usr_input != 'p') && (usr_input != 'n')) {
...

            {
              ...
              wait_1_sec(1); // Allow time for PWM to run and stabilise
              printstr("\nReading ADC....");

              adc4_value = ms_adc_c.ms_adc4_pwm();
              adc5_value = ms_adc_c.ms_adc5_pwm();

              adc4_status = ((adc4_value >= PWM_MIN) && (adc4_value <= PWM_MAX))?PASS:FAIL;   // +/- 2% duty cycle
              adc5_status = ((adc5_value >= PWM_MIN) && (adc5_value <= PWM_MAX))?PASS:FAIL;   // +/- 2% duty cycle
              ...
              adc6_status = ((adc6_value >= PWM_MIN) && (adc6_value <= PWM_MAX))?PASS:FAIL;   // +/- 2% duty cycle
              adc7_status = ((adc7_value >= PWM_MIN) && (adc7_value <= PWM_MAX))?PASS:FAIL;   // +/- 2% duty cycle
...

            {
              ...
              printstr("\n\t       XMOS\n\t    A--------B\n\t    | \\      |\n\t    |  \\()   |\n\t    |        |\n\t    D--------C\n");
              printstr("\nMove the Joystick to Position A and Hold it \nPress 'Enter'");
              getchar();    /**< Waiting for 'Enter' from tester will stall the running adc conversion,pwm */
              wait_1_sec(1);
              printstr("\nReading ADC....");
              ...
              joystick_status = ((adc2_value >= POS_A_ADC2_MIN) && (adc2_value <= POS_A_ADC2_MAX))?PASS:FAIL;    // +/- 10 (208,33)=actual
              joystick_status += ((adc3_value >= POS_A_ADC3_MIN) && (adc3_value <= POS_A_ADC3_MAX))?PASS:FAIL;   // +/- 10

              printstr("\nADC2_JOYSTICK Position A:");printuint(adc2_value);printchar(',');
              printstr(((adc2_value >= POS_A_ADC2_MIN) && (adc2_value <= POS_A_ADC2_MAX))?"PASS":"FAIL");
              printstr("\nADC3_JOYSTICK Position A:");printuint(adc3_value);printchar(',');
              printstr(((adc3_value >= 26) && (adc3_value <= 40))?"PASS":"FAIL");

              printstr("\n\t       XMOS\n\t    A--------B\n\t    |      / |\n\t    |   ()/  |\n\t    |        |\n\t    D--------C\n");
              printstr("\nMove the Joystick to Position B and Hold it \nPress 'Enter'");
              getchar();    /**< Waiting for 'Enter' from tester will stall the running adc conversion,pwm */
              wait_1_sec(1);
              printstr("\nReading ADC....");
              ...
              adc2_value = ms_adc_c.ms_adc2_joystick();
              adc3_value = ms_adc_c.ms_adc3_joystick();
              joystick_status += ((adc2_value >= POS_B_ADC2_MIN) && (adc2_value <= POS_B_ADC2_MAX))?PASS:FAIL;  // +/- 10 (208,216)=actual
              joystick_status += ((adc3_value >= POS_B_ADC3_MIN) && (adc3_value <= POS_B_ADC3_MAX))?PASS:FAIL;  // +/- 10

              printstr("\nADC2_JOYSTICK Position B:");printuint(adc2_value);printchar(',');
              printstr(((adc2_value >= POS_B_ADC2_MIN) && (adc2_value <= POS_B_ADC2_MAX))?"PASS":"FAIL");
              printstr("\nADC3_JOYSTICK Position B:");printuint(adc3_value);printchar(',');
              printstr(((adc3_value >= POS_B_ADC3_MIN) && (adc3_value <= POS_B_ADC3_MAX))?"PASS":"FAIL");

              printstr("\n\t       XMOS\n\t    A--------B\n\t    |        |\n\t    |   ()\\  |\n\t    |      \\ |\n\t    D--------C\n");
              printstr("\nMove the Joystick to Position C and Hold it \nPress 'Enter'");
              getchar();    /**< Waiting for 'Enter' from tester will stall the running adc conversion,pwm */
              wait_1_sec(1);
              printstr("\nReading ADC....");
              ...
              adc2_value = ms_adc_c.ms_adc2_joystick();
              adc3_value = ms_adc_c.ms_adc3_joystick();
              joystick_status += ((adc2_value >= POS_C_ADC2_MIN) && (adc2_value <= POS_C_ADC2_MAX))?PASS:FAIL;    // +/- 10 (30,220)=actual
              joystick_status += ((adc3_value >= POS_C_ADC3_MIN) && (adc3_value <= POS_C_ADC3_MAX))?PASS:FAIL;    // +/- 10

              printstr("\nADC2_JOYSTICK Position C:");printuint(adc2_value);printchar(',');
              printstr(((adc2_value >= POS_C_ADC2_MIN) && (adc2_value <= POS_C_ADC2_MAX))?"PASS":"FAIL");
              printstr("\nADC3_JOYSTICK Position C:");printuint(adc3_value);printchar(',');
              printstr(((adc3_value >= POS_C_ADC3_MIN) && (adc3_value <= POS_C_ADC3_MAX))?"PASS":"FAIL");

              printstr("\n\t       XMOS\n\t    A--------B\n\t    |        |\n\t    |  /()   |\n\t    | /      |\n\t    D--------C\n");
              printstr("\nMove the Joystick to Position D and Hold it \nPress 'Enter'");
              getchar();    /**< Waiting for 'Enter' from tester will stall the running adc conversion,pwm */
              wait_1_sec(1);
              printstr("\nReading ADC....");
              ...
              adc2_value = ms_adc_c.ms_adc2_joystick();
              adc3_value = ms_adc_c.ms_adc3_joystick();
              joystick_status += ((adc2_value >= POS_D_ADC2_MIN) && (adc2_value <= POS_D_ADC2_MAX))?PASS:FAIL;  // +/- 10 (27,36)=actual
              joystick_status += ((adc3_value >= POS_D_ADC3_MIN) && (adc3_value <= POS_D_ADC3_MAX))?PASS:FAIL;  // +/- 10

              printstr("\nADC2_JOYSTICK Position D:");printuint(adc2_value);printchar(',');
              printstr(((adc2_value >= 20) && (adc2_value <= POS_D_ADC2_MAX))?"PASS":"FAIL");
              printstr("\nADC3_JOYSTICK Position D:");printuint(adc3_value);printchar(',');
              printstr(((adc3_value >= POS_D_ADC3_MIN) && (adc3_value <= POS_D_ADC3_MAX))?"PASS":"FAIL");
            }
...

            {
              ...
              printstr("\n\tADC2            : "); printstr((joystick_status == 8)?"PASS":"FAIL");
              printstr("\n\tADC3            : "); printstr((joystick_status == 8)?"PASS":"FAIL");
...
void app_adc_handler(server interface i_mxdsig_adc ms_adc_s, chanend c_adc)
{
  ...
  while(1)
  {
    select
    {
      case adc_trigger_timer when timerafter(adc_trigger_time) :> int now: {
        at_adc_trigger_packet(trigger_port, adc_config);    //Trigger ADC
        adc_trigger_time = now + ADC_TRIGGER_PERIOD;
        break;
